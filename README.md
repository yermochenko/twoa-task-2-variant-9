# Приложение для расчёта геометрической задачи для варианта №9

Приложение должно позволять по введённым координатам двух вершин равностороннего треугольника $(x_1, y_1)$ и
$(x_2, y_2)$ вычислять координаты третьей вершины, а также координаты центра и радиус описанной вокруг этого
треугольника окружности. Приложение должно выводить оба возможных варианта.
...
* координаты центра и радиус описанной вокруг треугольника окружности для первого варианта;
* координаты всех трёх вершин треугольника для второго варианта;
* координаты центра и радиус описанной вокруг треугольника окружности для второго варианта.
